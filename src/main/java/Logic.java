...
public class Logic {
                ...
                if(action.getAction().equals(actions.get(i))){
                    ...
                    if(i == actions.size()-1){
                        if(currentState.isFinal()){
                            System.out.println("exited in a final state. Actions were correct");
                        } else if(!currentState.isFinal()){
                            System.out.println("exited in a non-final state. Actions were wrong and developers need to fix this!");
                        }
                    }
                }
            }
    ...
    public void getActionsFromFileAndExecute(State startState) throws IOException {
        File file = new File("/home/hvn15/IdeaProjects/Mini-Project-Web-Services/Assignment4Diskret/src/main/resources/LogEntry.txt");
